function [mu, L, W, error_tot] = gc_update_mu_L_W(ParamaUpdate, Param, Bayes, Yk, thr_val, count_break, iter, W_sim, update_coef_W)
...
while thr > thr_val && count < count_break
    ...
    if W_update==1
        ...
        [W, W_diff]  = gc_estimate_W_2d_1(MU_smoother, SIGMA_smoother, Yk, mu, W, L, incongruent_vec,iter, W_sim, update_coef_W);
